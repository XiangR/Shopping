...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
  ...
  <tr> 
    <td width="1"></td>
    <td width="96%"><IFRAME  name="LIST" WIDTH="100%" HEIGHT="90%" MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0 SCROLLING=auto BORDERCOLOR="#000000" SRC="AdminTree.jsp"> 
      </IFRAME></td>
    <td width="3"></td>
  </tr>
</table>
