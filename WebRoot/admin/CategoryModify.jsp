<%@ page language="java" import="com.xiangR.shopping.category.*" contentType="text/html; charset=utf-8"%>
...
<%
	...
	if(action != null && action.trim().equals("modify")) {
		...
		out.println("祝贺你，修改成功！ ");
	}
	
%>

<html><head><title>金尚商城添加根类别</title>
...
<td class="altbg2"><input name="name" size="25" maxlength="25" type="text" value=""> 
</tr>
