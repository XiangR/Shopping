...
<%
	...
	// 使用这种方式在得到 count的时候也加载了products
	...
	int productCount = ProductMgr.getInstance().getProducts(products, pageNo, PAGE_SIZE);
	int totalPage = (productCount + PAGE_SIZE - 1) / PAGE_SIZE;
	
	if(pageNo > totalPage) {
		pageNo = totalPage;
	}
	
	System.out.println("PageNo: " + pageNo + " productPage: " + productCount );
%>
<html>
	<head>
		<title>会员列表</title>
