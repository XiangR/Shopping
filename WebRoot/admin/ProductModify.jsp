...
<%@ page language="java" import="com.xiangR.shopping.product.*" contentType="text/html; charset=utf-8" pageEncoding="utf-8"%>
...
<body leftmargin="0" rightmargin="0" topmargin="0"
	...
	<form method="post" name="formModify" action="ProductModify.jsp" onsubmit="return check()">
		<input type="hidden" name="action" value="add" /> <input type="hidden"
			name="id" value="<%=id%>" />
		...
		<table class="tableborder" align="center" cellpadding="4"
			...
			<tbody>
				...
				<tr>
					...
					<td class="altbg2"><input name="normalPrice" size="25" type="text" value="<%=p.getNormalPrice()%>">
					</td>
				</tr>
				<tr>
					<td class="altbg1">会员价格:</td>
					<td class="altbg2"><input name="memberPrice" size="25" type="text" value="<%=p.getMemberPrice()%>">
					</td>
				</tr>

				<tr>
					<td class="altbg1">所属类别</td>
					<td class="altbg2"><select name="categoryId">
							<%
				...
				<tr>
					...
					<td class="altbg2">
						<textarea name="descr" cols="60" rows="5" id="descr">
							<%=p.getDescr() %>
						</textarea>
					</td>
				</tr>
