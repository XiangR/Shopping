...
<%
	...
	String strCategory = request.getParameter("categoryId");
	int categoryId = 0;
	...
	if(action != null && action.trim().equals("add")) {
		...
		// 加入一个功能 在非叶子节点下不能添加
		Category c = CategoryDAO.loadById(categoryId);
		if(!c.isLeaf()) {
			out.println("不是叶子节点， 我们不应该在这里添加商品！");
			return;
		}
		 ...
		 <table class="tableborder" align="center" cellpadding="4" cellspacing="1" width="97%">
			<tbody>
				...
				<tr>
					...
					<td class="altbg2"><input name="normalPrice" size="25"
						type="text">
					</td>
				</tr>
				<tr>
					<td class="altbg1">会员价格:</td>
					<td class="altbg2"><input name="memberPrice" size="25"
						type="text">
					</td>
				</tr>
				...
				<tr>
					...
					<td class="altbg2">
				<%--	<input name="categoryId" size="25" type="text"> --%>
