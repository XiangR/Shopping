<%@ page language="java" import="com.xiangR.shopping.product.*" pageEncoding="utf-8"%>
																						...
																						<table style="border-collapse: collapse;"
																							...
																							<tbody>
																								<tr>
																									...
																									<!-- 这里的显示图片上 有删除一个 /product -->
																										<a
																											href="ShowProductDetail.jsp?id=<%=p.getId()%>"
																											class="mingcheng1"> <img src="images/product/<%=p.getId() + ".gif"%>"
																												border="0" height="90" width="75"> </a>
																									</td>
																									<td width="492">
																										<a href="ShowProductDetail.jsp?id=<%=p.getId()%>" class="mingcheng1"><%=p.getName()%></a>&nbsp;
																									</td>
																									<td rowspan="2" align="center" width="141">
																										<a href="Buy.jsp?id=<%=p.getId()%>&action=add"
																											target="cart"> <img src="images/xiaoche.gif" border="0"> </a>
																									</td>
																								</tr>
																								<tr>
																									<td width="492">
